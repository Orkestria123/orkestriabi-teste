-- ============================================================
-- Transferência de resultado do ECD não pode entrar na DRE
-- ============================================================
--
-- O I200 IND_LCTO=E (e o I155 do último mês) zera toda conta de
-- resultado. Sem isolar isso, setembro (ou dezembro) fica com o
-- negativo do acumulado e o ano some zero. Este ECD não traz
-- histórico no I250 — a correção por texto nunca pegava.
--
-- Nas contas 3–6 que fecham o mês em zero: o lado contrário ao
-- saldo inicial é o encerramento; a DRE fica só com o movimento
-- do período. O PL no Balanço não é tocado.
...
-- Receita (saldo inicial credor / negativo): encerra no débito.
-- Despesa (saldo inicial devedor / positivo): encerra no crédito.
...
-- Já aplicado: reescreve saldos e tira as partidas do diário.
DO $do$
DECLARE
  _imp uuid;
  _tenant uuid;
